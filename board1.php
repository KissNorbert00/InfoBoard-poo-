...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="./logIn/view/css/cssImg/sig.png"/>
        <title>Kijelző 1</title>

        <script>
	        setTimeout(function () { doesConnectionExist(); }, 900000);
                ...
                function processRequest(e) {
                    if (xhr.readyState == 4) {
                        if (xhr.status >= 200 && xhr.status < 304) {
                            ...
                            setTimeout(function () { doesConnectionExist(); }, 600000);
                        }
                    }
                }
            }
